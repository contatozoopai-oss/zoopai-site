...
export default function ZoopAI() {
  ...
  async function iniciar() {
    ...
    await playZoopVoice(
      "Bem vindo. Eu sou ZoopAI. Iniciando conexão com seu sistema."
    );
    ...
    await playZoopVoice(
      "Conexão estabelecida. Sistema sincronizado."
    );
  ...
  return (
    <div style={container}>
      ...
      <div style={center}>
        ...
        <div style={title}>ZOOPAI</div>

        <div style={subtitle}>
          Entidade Cognitiva Ativa
        </div>

        <button onClick={iniciar} style={button}>
...
const container = {
  minHeight: "100vh",
  background: "radial-gradient(circle,#020a14,#000)",
  display: "flex",
